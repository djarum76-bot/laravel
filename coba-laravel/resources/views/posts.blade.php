...
@section('container')
    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            @else
                <img src="https://source.unsplash.com/1200*400?{{ $posts[0]->category->name }}" class="card-img-top" alt="...">
            @endif
            ...
            @foreach ($posts->skip(1) as $post)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        @else
                            <img src="https://source.unsplash.com/500*500?{{ $post->category->name }}" class="card-img-top" alt="...">
                        @endif
                        <div class="card-body">
